...
public class Robot extends TimedRobot {
  ...
  public void robotPeriodic() {
    ...
    DogLog.log("RoboRIO/CAN Status/Bus Off Count", rioCanStatus.busOffCount);
    DogLog.log(
    ...
    DogLog.log("RoboRIO/CAN Status/Tx Full Count", rioCanStatus.txFullCount);
    DogLog.log("RoboRIO/CPU Temperature", RobotController.getCPUTemp());
    DogLog.log("RoboRIO/RSL", RobotController.getRSLState());
    DogLog.log("RoboRIO/Input Current", RobotController.getInputCurrent());
